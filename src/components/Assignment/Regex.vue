        ...
        <table class="items-center w-full bg-transparent border-collapse">
          ...
          <tbody>
            <tr v-for="(item, index) in questions" :key="index">
              ...
              >
                <img
                  src="https://kasunkodagoda.gallerycdn.vsassets.io/extensions/kasunkodagoda/regex-match-replace/2.1.5/1567104415777/Microsoft.VisualStudio.Services.Icons.Default"
